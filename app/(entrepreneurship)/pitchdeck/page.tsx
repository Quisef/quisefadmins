...
export default function PitchDeckSubmission() {
  ...
  // ── Form page ───────────────────────────────────
  // Shared input class builder — text-gray-900 ensures black typed text
    ...
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 via-white to-teal-50/30 py-12 px-5">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mt-8">
          <a href="/futurentrepreneurship" className="inline-flex items-center gap-2 text-emerald-700 hover:text-emerald-800 font-semibold transition">
